...
import 'presentation/actions/product.actions/open_product_action.dart' as _i13;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i11.MyApp>(
      () => _i11.MyApp(appRouter: get<_i9.AppRouter>(), key: get<_i12.Key>()));
  gh.factory<_i13.OpenProductAction>(
      () => _i13.OpenProductAction(get<_i7.ActionsDelegate>()));
  gh.factory<_i14.ProductsListBloc>(() => _i14.ProductsListBloc(
      listProducts: get<_i10.ListProductsUsecase>(),
      openProduct: get<_i13.OpenProductAction>()));
  return get;
}
